...
class AffirmationsTableViewController: UITableViewController, UITableViewDataSource, NSFetchedResultsControllerDelegate
{
    ...
    override func viewDidLoad() {
        ...
        func initializeFetchedResultsController() {
            let request = NSFetchRequest(entityName: "Affirmation")
            ...
            let moc = self.MyCoreDataController.managedObjectContext
    ...
    func configureCell(cell: UITableViewCell, indexPath: NSIndexPath) {
        let employee = self.fetchedResultsController.objectAtIndexPath(indexPath) as! Affirmation
        // Populate cell from the NSManagedObject instance
        print("Object for configuration: \(object)")
    }
    
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("cellIdentifier", forIndexPath: indexPath) as! AffirmationsTableViewCell
        // Set up the cell
